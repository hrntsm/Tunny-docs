export * as gfm from "https://deno.land/x/gfm@0.1.25/mod.ts";
...
import "https://esm.sh/prismjs@1.29.0/components/prism-python.js?no-check";
import "https://esm.sh/prismjs@1.29.0/components/prism-csharp.js?no-check";
import "https://esm.sh/prismjs@1.29.0/components/prism-diff.js?no-check";
import "https://esm.sh/prismjs@1.29.0/components/prism-bash.min?no-check";
